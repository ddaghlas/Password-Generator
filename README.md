# Password-Generator
I was tasked with creating a password generator that enables employeesto generate random paswords based on criteria that they've selected. The app is run in the browser that features drynamically updat3ed HTML and CSS powered by the JavaScript code I've written. The code is meant to be clean and polished with a responsive user interface that adpats to multiple screen sizes. The password can also include special characters. 
...
- When the employee is prompted for characcter types to include, they are able to choose lowercase, uppercase, numeric, and/or special characters.
